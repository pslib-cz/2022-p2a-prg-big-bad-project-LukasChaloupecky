    ...
    public static class Menu
    {
        ...
        public static void StartNewGame(ref Game game, ref bool IsRunning, ref int TimeOut)
        {
            ...
            while (!CorrectValue)
            {
                ...
                Console.WriteLine("Set box lenght - [ Min = 20 , Max =  (100, the max can depend on your device) ]- recommended 70");
            ...
            while (!CorrectValue)
            {
                Console.WriteLine("Set box height - [ Min = 20 , Max = (100, the max can depend on your device) ] - recommended 20,");
